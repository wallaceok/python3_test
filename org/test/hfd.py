...
url = "http://hfd.1fangxin.net"
postdata =urllib.parse.urlencode({
"username":"13523715133",
"password":"abc123456"
}).encode('utf-8')
header = {
...
req = urllib.request.Request('http://hfd.1fangxin.net/api/v1/user/login',postdata,header)
...
req = urllib.request.Request("http://hfd.1fangxin.net/api/v1/new_community?pageIndex=1&limit=90&city=159&houseType=")
r1 = opener.open(req)
...
for l in list1:
    ...
    "houseType":"",
    "budget":"",
    "arriveTime":"2018-09-30",
    "more":""
    }).encode('utf-8')
    #print(postdata1)
    time.sleep(2)
    req = urllib.request.Request('http://hfd.1fangxin.net/api/v1/customer/create',postdata1,header1)
    time.sleep(2)
    r = opener.open(req)
